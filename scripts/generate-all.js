...
['infinity','infinity-device','무한대','무한 기호','연산, 수학 기호'],
['shapes','shapes','도형모음','다양한 도형','입력장치, 터치 제스처'],
['fingerprint-pattern','fingerprint2','지문패턴','지문 인식 패턴','생체인식, 보안 인증'],
['combine','combine','결합','장치 결합','모듈 결합, 복합 기기'],
],
...
['atom','atom-pc','원자','원자 구조','전자공학 기초, 반도체'],
['flame','flame-sensor','화염센서','불꽃 감지 센서','화재 감지, 안전'],
['droplet','water-sensor','수분센서','수분 감지 센서','수분 감지, 스마트팜'],
['cone','cone-sensor','콘센서','원뿔형 감지 범위','센서 범위, 초음파 패턴'],
['hand-helping','hand-sensor','터치센서','접촉 감지 센서','터치 입력, 정전식'],
['shapes','module-shapes','모듈도형','센서 모듈 종류','다양한 모듈, 선택 가이드'],
['binary-tree','circuit-tree','회로트리','회로 분기 구조','회로 설계, 전류 분기'],
...
['combine','combine-code','결합','코드 결합','모듈 통합, 빌드'],
...
['scale-3d','3d-code','3D코드','3차원 프로그래밍','게임 개발, 3D 그래픽'],
['infinity','infinity-loop','무한루프','끝없는 반복','무한루프, 종료 조건'],
['ratio','ratio','비율','비율 계산','화면 비율, 수학 연산'],
['proportions','proportions','비례','비례 관계','CSS 비율, 레이아웃'],
...
['scale','scale-balance','저울','균형 비교','값 비교, 가중치'],
['shapes','decomposition','분해','문제 분해','분해 사고, 서브문제'],
['combine','combine-algo','합성','문제 합성','부분 결합, 통합'],
['infinity','infinity-algo','무한','무한 개념','수학적 무한, 극한'],
...
['hand-helping','hand-trust','신뢰손','신뢰 기반 연결','디지털 신뢰, 웹 오브 트러스트'],
['handshake','handshake-net','핸드셰이크','통신 협상','프로토콜, TCP 핸드셰이크'],
['map-pin','location','위치표시','위치 핀','위치 기반 서비스, GPS'],
],
'06-data-ai': [
...
['proportions','data-ratio','데이터비율','데이터 비율','비율 분석, 파이'],
...
['shapes','shapes-dt','도형모음','다양한 형태','프로토타입 형태, 다양성'],
...
['shapes','shapes-steam','도형모음','여러 도형','수학, 기하학'],
...
['shapes','shapes-all','도형모음','여러 도형 모음','도형 분류, 기하학'],
